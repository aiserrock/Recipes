...
import com.akvelon.foodrecipes.util.Constants.Companion.PREFERENCES_DIET_TYPE_ID
...
class DateStoreRepository @Inject constructor(@ApplicationContext private val context: Context) {
